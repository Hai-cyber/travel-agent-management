...
### 1. SaaS Tour Builder
- Destinations + services (5 groups)
- Itinerary composer
- Pricing + visual configuration
...
- Most service todo fields should be auto-filled from tour and destination schedule context.
- Example:
  - set tour start date
  - auto-create Day-1 pickup + welcome todos
  - set destination order and nights
