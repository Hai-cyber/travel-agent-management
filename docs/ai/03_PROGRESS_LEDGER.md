...
| CHK-R64 | Showcase-only platform subdomains + commercial activation on custom domains | in_progress | Showcase publish is being separated from commerce across docs and runtime. Target rule: platform subdomains may publish content only; booking/payment flows require verified custom domain + commercial activation. | 2026-04-14 | Must update publish gate, public config, booking firewall, storefront CTA rendering, and legal/policy docs together. |
