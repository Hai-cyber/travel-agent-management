...
> RUNTIME NOTE: Most of this test plan is future scope. Only a small subset is testable in the current rescue runtime.

# Test Plan

Test scopes, strategy, and acceptance criteria.

## Current testable scope (rescue runtime)
- preview endpoints for tours/destinations/tour_stops
- basic DB connectivity

## Planned test scope (after future checkpoints)
